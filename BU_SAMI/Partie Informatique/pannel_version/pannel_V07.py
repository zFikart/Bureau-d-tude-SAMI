...
##
    ...
    def aff_coord(self):
        if self.mocap_node:
            ...
            while True:
                ...
                print(f"Temps : {nb_sec:10.7f} ; pos : ({self.position_tuple[0]:.8f}, {self.position_tuple[0]:.8f}) ; rot : {self.rotation_tuple:.8f}")
    ...
    def update_coord(self):
        self.lab_coord_pos.config(text = f"{self.position_tuple}")
    ...
    def create_widgets(self):
        ...
        self.ani = animation.FuncAnimation(self.fig, self.update_graph, frames = len(self.coordinates), \
